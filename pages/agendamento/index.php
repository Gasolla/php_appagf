...
<div class="row" >
    <div class="col-md-12 col-sm-12">
        <h3  class="h3-1">Cadastro Agendamento Coleta</h3>
        <hr>
    </div>
</div>
<form class="form-group" name="formulario" id="formulario" 
    ...
    <div class="panel-body">
        ...
        <div class="form-row">
            <div class="form-group col-xs-12  col-sm-6 col-md-6 col-lg-3 " id="form-cidata">  
                <label for="cidata">Data Inicial</label><!--Este campo Pesquisa na Tabela notificação (DtHr)-->
                <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" 
                    ...
                    <input  type="text" class="form-control datepicker" id="cidata" placeholder="Data Inicial" 
                            ...
                            value="<?php echo (isset($_REQUEST['cidata']) ? $_REQUEST['cidata'] : date('d/m/Y')) ?>"/>
                    <div class="input-group-addon imput-calendario">
                        <i class="fas fa-calendar-alt fa-2x"></i>
                    </div>
                </div>
            </div>
            <div class="form-group col-xs-12  col-sm-6 col-md-6 col-lg-3" id="form-cfdata">  
                <label for="cfdata">Data Final</label>
                <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" 
                     data-date-language="pt-BR" data-date-autoclose="true" 
                     data-date-today-highlight="true" data-date-orientation="bottom"> 
                    <input  type="text" class="form-control datepicker" id="cfdata" placeholder="Data Final" 
                            ...
                            value="<?php echo (isset($_REQUEST['cfdata']) ? $_REQUEST['cfdata'] : date('d/m/Y')) ?>"/>
                    <div class="input-group-addon imput-calendario">
                        <i class="fas fa-calendar-alt fa-2x"></i>
                    </div>
                </div>
            </div>
            <div class="form-group col-xs-12  col-sm-12 col-md-12  col-lg-6" id="form-cliente_id">  
        ...
        <div class="form-row">
            <div class="form-group col-xs-12  col-sm-6 col-md-6  col-lg-6" id="form-usuario_id">  
                <?php $controller->addMotorista(false); ?>
            ...
            <div class="form-group col-xs-12  col-sm-6 col-md-6  col-lg-6" id="form-status">  
