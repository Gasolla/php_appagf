...
<div class="row" >
    <div class="col-md-12 col-sm-12">
        <h3  class="h3-1">Rastreador Web</h3>
        <hr>
    </div>
</div>
<form class="form-group" name="formulario" id="formulario" 
    ...
    <div class="panel-body">
        <div class="form-row">
            ...
            <div class="form-group col-xs-6  col-sm-6 col-md-3  col-lg-4" id="form-objeto">  
            ...
            <div class="form-group col-xs-6  col-sm-6 col-md-3  col-lg-4" id="form-status"> 
                <div class="form-row">
                    <label for="status">Status</label>
                    <select name="status" id="status" rel="select2" class="form-control">
                        <option value="">TODOS</option>
                        <option value="C" <?php echo ((isset($_REQUEST['status']) && ($_REQUEST['status'] === "ANDAMENTO")) ? "selected='true'" : "") ?>>ANDAMENTO</option>
                        <option value="I" <?php echo ((isset($_REQUEST['status']) && ($_REQUEST['status'] === "POSITIVO")) ? "selected='true'" : "") ?>>POSITIVO</option>
                        <option value="A" <?php echo ((isset($_REQUEST['status']) && ($_REQUEST['status'] === "NEGATIVO")) ? "selected='true'" : "") ?>>NEGATIVO</option>
                    </select>
                </div>
            </div>
        </div>
