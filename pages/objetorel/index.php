...
<div class="row" >
    <div class="col-md-12 col-sm-12">
        <h3  class="h3-1">Relatório Coleta Objeto</h3>
        <hr>
    </div>
</div>
<form class="form-group" name="formulario" id="formulario" 
    ...
    <div class="panel-body">
        ...
        <div class="form-row">
            <div class="form-group col-xs-6  col-sm-6 col-md-4  col-lg-3 " id="form-cidata">  
            ...
            <div class="form-group col-xs-6  col-sm-6 col-md-4  col-lg-3" id="form-cfdata">  
            ...
            <div class="form-group col-xs-6  col-sm-6 col-md-4  col-lg-3 " id="form-pidata">  
                <label for="pidata">Inicial Postagem</label><!--Este campo Pesquisa na Tabela notificação (DtHr)-->
                <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" 
                     data-date-language="pt-BR" data-date-autoclose="true" 
                     data-date-today-highlight="true" data-date-orientation="bottom"> 
            ...
            <div class="form-group col-xs-6  col-sm-6 col-md-4  col-lg-3" id="form-pfdata">  
                <label for="pfdata">Final Postagem</label>
                <div class="input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" 
                     data-date-language="pt-BR" data-date-autoclose="true" 
                     data-date-today-highlight="true" data-date-orientation="bottom"> 
        ...
        <div class="form-row">
            <div class="form-group col-xs-6  col-sm-6 col-md-8  col-lg-8" id="form-cliente_id"> 
            ...
            <div class="form-group col-xs-6  col-sm-6 col-md-4  col-lg-4" id="form-objeto">  
                <label for="objeto">Objeto</label>
                <input  type="text" class="form-control" id="objeto"  placeholder="digite o objeto"  maxlength="13"
                        name="objeto"  value="<?php echo ((isset($_REQUEST['objeto'])) ? $_REQUEST['objeto'] : "") ?>"/>
            </div>     
        </div>
