...
<div  class="table-responsive class-grid" id="listacliente" >
    <table border="0" width="2000" class="table-bordered">
        ...
        <thead>
            <tr>
                ...
                <th scope="col" class='text-center th-grid'>DOCUMENTO</th>
        ...
        <tbody>
            ...
            $contzebra = 0;
            if ($sucesso===true) {
                foreach ($controller->getCliente() as $key => $value) {
                    if($contzebra % 2 == 0){
                    ...
                    <tr id='<?php echo crypto::encrypt($value->getId()) ?>'> 
                        ...
                        <td class='text-center td-grid' <?php echo $color ?>><?php echo $value->getDocumento() ?></td> 
