...
require('classes/prospeccao.php');
require('classes/prospeccaohistorico.php');
require('controller/prospeccaoController.php');
...
$menu = ("Utilitario");
$controller = new prospeccaoController($_REQUEST, $conexao, $usuarioacesso);
?>
