...
require('classes/estoquecliente.php');
require('controller/estoqueclienteController.php');
...
$menu = ("Movimentacao");
$controller = new estoqueclienteController($_REQUEST, $conexao, $usuarioacesso);
?>
