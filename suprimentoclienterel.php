...
require('classes/suprimentocliente.php');
require('controller/suprimentoclienterelController.php');
...
$menu = ("Relatorio");
$controller = new suprimentoclienterelController($_REQUEST, $conexao, $usuarioacesso);
?>
